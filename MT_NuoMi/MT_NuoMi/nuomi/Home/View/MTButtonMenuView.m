...
@implementation MTButtonMenuView
...
-(id)initWithFrame8:(CGRect)frame subtitle:(NSString *)subtitle title:(NSString *)title imagestr:(NSString *)imagestr
{
    ...
    if(self)
    {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:imagestr] placeholderImage:[UIImage imageNamed:@"icon_nav_cart_normal"]];
...
-(id)initWithFrame2:(CGRect)frame title:(NSString *)title imagestr:(NSString *)imagestr
{
    ...
    if(self)
    {
        ...
        UILabel *imageView = [[UILabel alloc]initWithFrame:CGRectMake(frame.size.width/3+8, 0, frame.size.width/2, frame.size.height)];
