...
#import "MTRecommendTableViewCell.h"
#import "MTTitleTableViewCell.h"
#import "MTGroupTableViewCell.h"

#import "JSDropDownMenu.h"
#import <SVProgressHUD.h>

@interface MTNearbyViewController ()<UITableViewDataSource,UITableViewDelegate,JSDropDownMenuDataSource,JSDropDownMenuDelegate>
{
...
@implementation MTNearbyViewController
...
-(void)initTableview
{
    ...
    UINib *nib1 = [UINib nibWithNibName:@"MTGroupTableViewCell" bundle:nil];
    //通过UINib对象注册相应的NIB文件
    ...
    [self.tableView registerClass:[MTTitleTableViewCell class] forCellReuseIdentifier:@"jbiaotiCell"];
...
-(void)rightBtnClick2:(UIButton *)button
{
    ...
    MTLoginAndRegisterViewController *denglu = [[MTLoginAndRegisterViewController alloc]initWithNibName:@"FYDengluViewController" bundle:nil];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        ...
        }else
        {
            ...
            MTRecommendTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier: @"jcell01"];
            if (cell == nil)
            {
                cell = [[MTRecommendTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier array:_dataShoplist];
            }
            cell.backgroundColor = [UIColor colorWithRed:0.93 green:0.93 blue:0.93 alpha:0.9];
            //cell.delegate = self;
    ...
    else
    {
        ...
        if (indexPath.row == 0)
        {
            MTTitleTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"jbiaotiCell" forIndexPath:indexPath];
        ...
        else if(indexPath.row == 3)
        {
            ...
            }else
            {
                ...
                MTGroupTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"jtuancell"];
